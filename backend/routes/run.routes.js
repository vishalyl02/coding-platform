...
// //             // 🆕 UPDATE TEST SCORE (sum of all problems in test)
// //             console.log("🔄 Updating test score for test:", testId);
// //             user.updateTestScore(testId);
            
// //             // 🆕 RECALCULATE TOTAL SCORE FROM ALL TESTS
// //             const allTests = user.testSubmissions;
// //             user.totalScore = allTests.reduce((sum, test) => sum + (test.score || 0), 0);
// //             console.log("🎯 New total score:", user.totalScore);
...
// //             console.log("✅ Score tracking complete");
// //             console.log("📊 Problem best score:", executionResult.score);
// //             console.log("📊 Test total score:", user.testSubmissions.find(t => t.testId === testId.toString())?.score || 0);
// //           } else {
// //             executionResult.bestScore = currentBestScore;
// //             executionResult.scoreImproved = false;
// //             console.log("ℹ️ Score not improved");
// //           }
// //         } else if (user && user.isTestSubmitted(testId)) {
// //           console.log("⚠️ Test already submitted - score not updated");
// //         }
// //       } catch (err) {
...
//     // RUN CODE THROUGH JUDGE (ALL test cases)
//     console.log("========================================");
//     console.log("🏃 EXECUTING CODE");
//     console.log("========================================");
...
//     // 🔥 Build test case results - show only first 3 with details
//     const testCaseResults = testCases.slice(0, 3).map((tc, idx) => {
//       const yourOutput = executionResult.outputs?.[idx];
//       const passed = executionResult.results?.[idx] === "AC";
...
//     console.log("========================================");
//     console.log("✅ TEST CASE RESULTS BUILT (first 3 shown):");
//     console.log("========================================");
...
//       verdict: executionResult.verdict,
//       passed: executionResult.passed,
//       total: executionResult.total, // 🔥 This is the total including hidden tests
//       score: executionResult.score || 0,
//       totalScore: 100,
//       message: executionResult.message,
//       error: executionResult.error,
//       bestScore: executionResult.bestScore,
//       scoreImproved: executionResult.scoreImproved,
//       testCaseResults: testCaseResults, // 🔥 Only first 3 with details
//     };

//     console.log("========================================");
//     console.log("✅ SENDING FINAL RESPONSE:");
//     console.log(`Total: ${executionResult.passed}/${executionResult.total} tests passed`);
//     console.log("========================================");
...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    // 🔥 Only show first 3 test cases with details
    const testCaseResults = testCases.slice(0, 3).map((tc, idx) => {
      const yourOutput = executionResult.outputs?.[idx];
      const passed = executionResult.results?.[idx] === "AC";
    ...
    const response = {
      ...
      verdict: executionResult.verdict,
      passed: executionResult.passed,
      total: executionResult.total, // 🔥 Total including ALL hidden tests
      score: executionResult.score || 0,
      totalScore: 100,
      message: executionResult.message,
      error: executionResult.error,
