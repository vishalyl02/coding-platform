...
function TestHeader({
  ...
  return (
    <div className="test-header-modern" style={{height:"24px"}}>
      <div className="test-header-left">
        <h2 className="test-header-title">Coding Challenge</h2>
      </div>

      <div className="test-header-right">
        <div className="test-timer" style={{height:"24px"}}>
        ...
        {!testStarted && !testSubmitted && (
          <button className="test-header-btn test-start-btn" onClick={onStart} style={{height:"20px"}}>
        ...
        {testStarted && !testSubmitted && (
          <button className="test-header-btn test-submit-btn" onClick={onSubmit} style={{height:"24px"}}>
            <svg className="test-header-btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
